    ...
    <div className="bg-white text-black p-8 max-w-4xl mx-auto text-sm border border-gray-400 rounded-md space-y-4">
      ...
      <ol className="list-decimal list-inside space-y-2">
        <li>
          ...
          <input type="text" className="border-b border-black w-2/3 inline-block" />
        </li>
        <li>
          Sex: <input type="text" className="border-b border-black w-1/3 inline-block" />
        </li>
        <li>
          Religion: <input type="text" className="border-b border-black w-1/2 inline-block" />
        </li>
        <li>
        ...
        <li>
          Date of appointment:{" "}
          <input type="date" className="border-b border-black w-1/3 inline-block" />
        </li>
        <li>
          Permanent address:
          <div className="ml-4 mt-2 space-y-1">
            <div>
              Village: <input type="text" className="border-b border-black w-40 inline-block" />
              &nbsp; Thana: <input type="text" className="border-b border-black w-40 inline-block" />
              &nbsp; Sub-division:{" "}
              <input type="text" className="border-b border-black w-40 inline-block" />
            </div>
            <div>
              Post Office:{" "}
              <input type="text" className="border-b border-black w-40 inline-block" />
